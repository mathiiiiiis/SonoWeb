  ...
  <div class="home">
          ...
          <div class="download-buttons">
            ...
            >
              ...
              >
                ...
                >
                  <g
                    id="shape-6cb705e6-02c2-8012-8006-6681cdae5f5e"
                    style="display: none"
                  >
                    <g
                      class="fills"
                      id="fills-6cb705e6-02c2-8012-8006-6681cdae5f5e"
                    >
                      <rect
                        width="45"
                        height="45"
            ...
            <button v-if="isIOS" class="btn-download secondary" disabled>
              ...
              >
                ...
                />
                <path
                  d="M13 3.5C13.73 2.67 14.94 2.04 15.94 2C16.07 3.17 15.6 4.35 14.9 5.19C14.21 6.04 13.07 6.7 11.95 6.61C11.8 5.46 12.36 4.26 13 3.5Z"
                  fill="currentColor"
                />
              </svg>
              Coming Soon for iOS
    ...
    <section class="scroll-text-section">
      <div
        ...
        :style="{ transform: `translateX(${scrollTextOffset}px)` }"
      >
        <span class="scroll-text"
          >FULLY FREE • LISTENS TO THE COMMUNITY • NO ADS • PRIVACY FIRST
          •&nbsp;</span
        >
        <span class="scroll-text"
          >FULLY FREE • LISTENS TO THE COMMUNITY • NO ADS • PRIVACY FIRST
    ...
    <nav class="bottom-nav">
      <div class="bottom-nav-container">
        <div class="nav-links">
          ...
          <a href="https://discord.sono.wtf" target="_blank" class="nav-link"
            >Discord</a
          >
        </div>
...
export default {
  ...
  data() {
    return {
      betaReleaseUrl:
        "https://github.com/mathiiiiiis/SonoAPK/releases/download/1.0.8-beta%2Be5852a9/1.0.8-beta+e5852a9.apk",
      scrollTextOffset: 0,
      observer: null,
      animationId: null,
      baseOffset: 0,
